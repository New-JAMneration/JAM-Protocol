...
func TestSignExtend(t *testing.T) {
	testCases := []struct {
		...
		{"InvalidInput1", 9, 0, 0, fmt.Errorf("invalid byte count: got 9")},
		{"InvalidInput2", -1, 0, 0, fmt.Errorf("invalid byte count: got 255")},
		{"InvalidInput3", 1, 1000, 0xffffffffffffffe8, nil},
		{"InvalidInput4", 7, 11, 0, fmt.Errorf("invalid byte count: got 7")},
		{"InvalidInput5", 0, 1, 1, nil},
	}

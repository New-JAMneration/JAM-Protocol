...
// 	e := GetEpochIndex(priorTau)
// 	ePrime := GetEpochIndex(posteriorTau)
...
// 	CreateEpochMarker(priorTau, posteriorTau)
...
// 	e := GetEpochIndex(priorTau)
// 	ePrime := GetEpochIndex(posterTau)
// 	m := GetSlotIndex(priorTau)
...
// 		e := GetEpochIndex(tc.slot)
// 		ePrime := GetEpochIndex(tc.slot)

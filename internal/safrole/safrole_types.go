...
func (e EpochKeys) Validate() error {
	if len(e) != types.EpochLength {
		return fmt.Errorf("EpochKeys must have exactly %d entries, got %d", types.EpochLength, len(e))
	}
	return nil
}
...
func (t TicketsBodies) Validate() error {
	if len(t) != types.EpochLength {
		return fmt.Errorf("TicketsBodies must have exactly %d entries, got %d", types.EpochLength, len(t))
	}
	return nil
}
...
func (v ValidatorsData) Validate() error {
	if len(v) != types.ValidatorsCount {
		return fmt.Errorf("ValidatorsData must have exactly %d entries, got %d", types.ValidatorsCount, len(v))
	}
	return nil
}
...
func (e *EpochMark) Validate() error {
	if len(e.Validators) != types.ValidatorsCount {
		return fmt.Errorf("EpochMark must have exactly %d validators, got %d", types.ValidatorsCount, len(e.Validators))
	}
	return nil
}
...
func (t TicketsMark) Validate() error {
	if len(t) != types.EpochLength {
		return fmt.Errorf("TicketsMark must have exactly %d TicketBody entries, got %d", types.EpochLength, len(t))
	}
	return nil
}

...
type OuterAccumulationInput struct {
	...
	DeferredTransfers            []types.DeferredTransfer  // t   a sequence of deferred transfers
...
type OuterAccumulationOutput struct {
	NumberOfWorkResultsAccumulated types.U64                      // n    the number of work-results accumulated

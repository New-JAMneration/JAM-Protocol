...
- [x] Step 4：錯誤處理 / retry policy（peer fallback、bulk 失敗不 panic）
- [x] Step 5：整合測試（mock fetch bulk catch-up）
- [x] Step 6：dual-node E2E placeholder（`sync_smoke_test.go` build tag integration，#567）
